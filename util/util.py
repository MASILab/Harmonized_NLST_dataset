...
def _convert_to_hu(normalized_slice):
    """
    Function to convert the normalized data into Housnfield units
    normalized slice: Output predicted by the model. Values in the range of [-1,1]
    """
    scale_range = [-1,1]
