...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--stage2_checkpoints', type=str, help='Path to stage 2 checkpoints (initial checkpoints are pretrained encoders and decoders)')
        # model parameters
        ...
        parser.add_argument('--netG_encoder', type=str, default='unet_512_encoder', help='specify generator encoder architecture [unet_512_encoder | resnet_encoder]')
        ...
        parser.add_argument('--stage', type=int, default=1, help='Which stage of the model to train. [1 | 2]')
        # additional parameters
        parser.add_argument('--epoch', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
        parser.add_argument('--load_iter', type=int, default='0', help='which iteration to load? if load_iter > 0, the code will load models by iter_[load_iter]; otherwise, the code will load models by [epoch]')
        parser.add_argument('--verbose', action='store_true', help='if specified, print more debugging information')
        parser.add_argument('--suffix', default='', type=str, help='customized suffix: opt.name = opt.name + suffix: e.g., {model}_{netG}_size{load_size}')
        parser.add_argument('--iter_accumulate', type=int, default=4, help='Number of iterations to accumulate gradients for')
        # wandb parameters
